'''
Training and evaluation for ARDEA object detection.
'''
import logging
import os
import torch
...
from p_detector.dataset import register_ardea_voc
from p_detector.configs import add_ardea_config, add_detr_config, p_detector_argument_parser
...
def main(args):
    ...
    # register ardea data-set using voc pascal format
    register_ardea_voc(name="ardea_train", dirname=cfg.DATA_DIR, split='train', year='2007')
    register_ardea_voc(name="ardea_test", dirname=cfg.DATA_DIR, split='test', year='2007')
